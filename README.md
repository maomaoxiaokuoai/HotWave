...
一站式聚合 **国内**（百度 / 微博 / B站 / 知乎 / 抖音）与 **海外**（Google Trends / Hacker News / X / YouTube）共 15 个平台的热门搜索榜单，全部实时抓取。
...
- **点击条目打开的是演示数据站**：个别平台接口在 Cloudflare 边缘节点上可能被限制，属于正常降级；国内平台与 Google/HN/X/YouTube 均可实时
